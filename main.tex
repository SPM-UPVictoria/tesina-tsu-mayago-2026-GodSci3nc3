...
\newcommand{\NombreAlumno}{Arturo Rosales Velázquez}
\soulregister{\NombreAlumno}{1}
% NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyecto}{Semáforo de Insumos IMSS} 
% Noten los \\ para insertar un ENTER del texto en el encabezado. NUNCA PONGAN EL TITULO EN MAYUSCULAS!!
\newcommand{\NombreProyectoheader}{Semáforo de Insumos IMSS}
\newcommand{\NombreTSU}{Tecnologías de la Información e Innovación Digital}
\newcommand{\UnidadEconomica}{Instituto Mexicano del Seguro Social (IMSS)}
\newcommand{\nasesorempresaria}   {Lic. José Espronceda Galván}
\newcommand{\nasesorinstitucional}{Dr. Said Polanco Martagón}
\newcommand{\Matricula}           {Por definir}  %SU MATRICULA
\newcommand{\ncuatrimestre}{Por definir}
% ESTA ES LA FECHA EN LA QUE EL ASESOR INSTITUCIONA EVALUA EL INFORME
\newcommand{\fechaAutorizacionInforme}               {Por definir} 
% ESTA ES LA FECHA EN LA QUE EL ASESOR INSTITUCIONA PROGRAMA LA EXPOSCION 
\newcommand{\DiaEvaluacionPesentacion}{Por definir}
\newcommand{\MesEvaluacionPesentacion}{Por definir}
\newcommand{\AnhoEvaluacionPesentacion}{Por definir}
\newcommand{\fechaPortada}               {\MesEvaluacionPesentacion~de~\AnhoEvaluacionPesentacion}
\newcommand{\HoraEvaluacionPesentacion}{Por definir}

\newcommand{\modalidadEvaluacionPesentacion}{Por definir} % Otras opciones: Virtual
\newcommand{\tipoAulaOficinaEnlacePesentacion}{Por definir} % Otras opciones: la oficia/el aula/enlace
\newcommand{\AulaEvaluacionOEnlaceMeetPesentacion}{Por definir} %otras opciones: si es un elance de meet, rodearlo \url{}
...
{\Large \textbf{AVANCE DE TESINA DE ESTADÍA PROFESIONAL}}\\[0.75cm]
...
EN CUMPLIMIENTO DE LA ESTADÍA PROFESIONAL EN\\
\textbf{\MakeUppercase{\ncarrera}}\\[0.75cm]
...
\begin{center}
{\Large \textbf{Formato de autorización para exposición de}}\\[0.125cm]
{\Large \textbf{Estadía Profesional}}\\[0.25cm]
\end{center}
...
\begin{center}
{\large \textbf{Control sumativo de Estadía Profesional}}
\end{center}
...
El presente avance de tesina documenta el contexto, el problema y los objetivos del proyecto \textit{Semáforo de Insumos IMSS}, desarrollado durante la estadía profesional en el Instituto Mexicano del Seguro Social. Se describe la necesidad de contar con un control de insumos más preciso y oportuno, así como el enfoque propuesto para registrar datos en tiempo real y convertirlos en un esquema de semaforización que apoye la toma de decisiones. El documento delimita alcances y limitaciones, integra antecedentes institucionales y teóricos y presenta el temario tentativo del marco teórico, dejando explícito que la investigación se encuentra en fase de campo y desarrollo, sin resultados ni conclusiones todavía.
...
This first thesis progress report documents the context, problem statement, and objectives of the \textit{IMSS Supply Traffic Light} project, developed during the professional internship at the Mexican Social Security Institute. It outlines the need for timely and reliable supply control and the proposed approach to capture real-time data and translate it into a visual traffic-light system to support operational decisions. The report defines scope and limitations, reviews institutional and theoretical background, and presents the tentative outline for the theoretical framework. The work is currently in the field and development phase, with no results or conclusions yet.
